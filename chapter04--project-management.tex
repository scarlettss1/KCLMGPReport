...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{risk_review.png} % Change filename accordingly
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{trello_tasks.png} % Change filename accordingly
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{task_list.png} % Change filename accordingly
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{discord_channels.png} % Change filename accordingly
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{whiteboard_meeting.png} % Change filename accordingly
